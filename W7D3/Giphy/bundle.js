...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(query) {
  return function (dispatch) {
    return APIUtil.fetchGiphys(query).then(function (response) {
  ...
  _createClass(SearchBar, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'text', value: this.state.term, onChange: this.handleChange }),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchSearchGiphys: function fetchSearchGiphys(query) {
      return dispatch((0, _giphy_actions.fetchSearchGiphys)(query));
    }
  };
};
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.store = store;
  window.fetchGiphys = _api_util.fetchGiphys;
  window.giphysReducer = _giphys_reducer.giphysReducer;
...
var giphysReducer = function giphysReducer() {
  ...
  switch (action.type) {
    case _giphy_actions.RECEIVE_SEARCH_GIPHYS:
      return [].concat(_toConsumableArray(state), _toConsumableArray(action.giphys));
    default:
      return state;
  }
};
...
var fetchGiphys = exports.fetchGiphys = function fetchGiphys(query) {
  var url = "http://api.giphy.com/v1/gifs/search?q=" + query + "&api_key=dc6zaTOxFJmzC&limit=2";
  return $.ajax(url);
};
